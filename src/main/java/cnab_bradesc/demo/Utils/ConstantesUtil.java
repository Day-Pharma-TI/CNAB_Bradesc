...
public final class ConstantesUtil {
    ...
    public static final String CODIGO_SEGMENTO_B = "B";
    public static final String CNPJ_EMPRESA = "08185611000163";
    public static final String AGENCIA_CONTA_EMPRESA = "0328";
    public static final String CONTA_CORRENTE_EMPRESA = "0000014787";
    public static final String NOME_EMPRESA = "DAY PHARMA EIRELI";
    ...
    public static final String CIDADE_EMPRESA = "ITU";
    public static final String CEP_EMPRESA = "13313";
    public static final String COMPLEMENTO_CEP = "650";
    public static final String UF_ESTADO = "SP";
    public static final String PAGAMENTO_SALARIO_TITLE = "PAGAMENTO DE SALÁRIOS";
