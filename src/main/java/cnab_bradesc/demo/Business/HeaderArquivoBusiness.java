...
public class HeaderArquivoBusiness {
    ...
    public HeaderArquivo gerarHearArquivo(){
        ...
        headerArquivo.setTipoInscricaoEmpresa(2);
        ...
        headerArquivo.setDigitoVerificadorDaAgencia("0");
        headerArquivo.setNumeroDaContaCorrente(ConstantesUtil.CONTA_CORRENTE_EMPRESA);
        headerArquivo.setDigitoVerificadorDaConta("7");
        ...
        headerArquivo.setDensidade("01600");
